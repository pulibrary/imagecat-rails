...
# This is an example of what we want our script to look like for transferring image files from a source location to a destination.
...
files.each do |file_name|
  ...
  s3_safe_file_name = "imagecat-#{file_parts[-4..-1].join("-")}"
